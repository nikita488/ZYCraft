...
import com.nikita488.zycraft.init.ModDamageSources;
import com.nikita488.zycraft.util.ParticleSpawn;
import com.nikita488.zycraft.util.QuartzCrystalShapes;
...
public class QuartzCrystalBlock extends Block
{
    ...
    {
        ParticleSpawn.quartzCrystal(state, world, pos, rand);
    }

    @Override
    public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context)
    {
        return QuartzCrystalShapes.get(state);
    }
