...
import com.nikita488.zycraft.init.ModBlocks;
...
{
    public ZychoriteVeinFeature(Function<Dynamic<?>, ? extends ZychoriteVeinConfig> factory)
    {
        super(factory);
    }

    @Override
    public boolean place(IWorld world, ChunkGenerator<? extends GenerationSettings> generator, Random rand, BlockPos pos, ZychoriteVeinConfig config)
    {
    ...
    private boolean doPlace(IWorld world, Random random, ZychoriteVeinConfig config, double p_207803_4_, double p_207803_6_, double p_207803_8_, double p_207803_10_, double p_207803_12_, double p_207803_14_, int p_207803_16_, int p_207803_17_, int p_207803_18_, int p_207803_19_, int p_207803_20_)
    {
        int blockCount = 0;
    ...
    public void setVeinBlock(IWorld world, BlockPos pos, Random random, ZychoriteVeinConfig config)
    {
