...
public class ZYLang
{
    ...
    public static final MutableComponent COLOR_SCANNER_CURRENT_COLOR = REGISTRATE.addLang("tooltip", ZYCraft.id("color_scanner"), "current_color", "Current color:")
            .withStyle(ChatFormatting.ITALIC, ChatFormatting.GRAY);
    public static final MutableComponent COLOR_SCANNER_RED = REGISTRATE.addLang("tooltip", ZYCraft.id("color_scanner"), "red", "Red:    %s")
            .withStyle(ChatFormatting.ITALIC, ChatFormatting.RED);
    public static final MutableComponent COLOR_SCANNER_GREEN = REGISTRATE.addLang("tooltip", ZYCraft.id("color_scanner"), "green", "Green: %s")
            .withStyle(ChatFormatting.ITALIC, ChatFormatting.GREEN);
    public static final MutableComponent COLOR_SCANNER_BLUE = REGISTRATE.addLang("tooltip", ZYCraft.id("color_scanner"), "blue", "Blue:   %s")
            .withStyle(ChatFormatting.ITALIC, ChatFormatting.BLUE);

    public static final MutableComponent SCYTHE_DURABILITY = REGISTRATE.addLang("tooltip", ZYCraft.id("scythe"), "durability", "Durability: %s%%");
    ...
    public static final MutableComponent FLUID_TANK_FILLED = REGISTRATE.addLang("tooltip", ZYCraft.id("fluid_tank"), "filled", "%s/%s mB")
            .withStyle(ChatFormatting.GRAY);

    public static final MutableComponent FABRICATOR = REGISTRATE.addLang("container", ZYCraft.id("fabricator"), "Fabricator");
    public static final MutableComponent TANK = REGISTRATE.addLang("container", ZYCraft.id("tank"), "Multi-Tank");

    public static final MutableComponent NARRATE_GAUGE = REGISTRATE.addLang("gui", ZYCraft.id("narrate"), "gauge", "%s gauge: filled %s of %s");

    public static final MutableComponent FABRICATOR_AUTO_LOW = REGISTRATE.addLang("mode", ZYCraft.id("fabricator"), "auto_low", "Auto: Low");
    public static final MutableComponent FABRICATOR_AUTO_HIGH = REGISTRATE.addLang("mode", ZYCraft.id("fabricator"), "auto_high", "Auto: High");
    public static final MutableComponent FABRICATOR_PULSE = REGISTRATE.addLang("mode", ZYCraft.id("fabricator"), "pulse", "Pulse");
    public static final MutableComponent VALVE_IN = REGISTRATE.addLang("mode", ZYCraft.id("valve"), "in", "Input")
            .withStyle(ChatFormatting.BLUE);
    public static final MutableComponent VALVE_OUT = REGISTRATE.addLang("mode", ZYCraft.id("valve"), "out", "Output")
            .withStyle(ChatFormatting.GOLD);
    public static final MutableComponent ITEM_IO_ANY = REGISTRATE.addLang("mode", ZYCraft.id("item_io"), "any", "Input/Output")
            .withStyle(ChatFormatting.WHITE);
    public static final MutableComponent ITEM_IO_ALL_IN = REGISTRATE.addLang("mode", ZYCraft.id("item_io"), "all_in", "Input")
            .withStyle(ChatFormatting.BLUE);
    public static final MutableComponent ITEM_IO_ALL_OUT = REGISTRATE.addLang("mode", ZYCraft.id("item_io"), "all_out", "Output")
            .withStyle(ChatFormatting.GOLD);
    public static final MutableComponent ITEM_IO_IN1 = REGISTRATE.addLang("mode", ZYCraft.id("item_io"), "in1", "Input1")
            .withStyle(ChatFormatting.DARK_PURPLE);
    public static final MutableComponent ITEM_IO_OUT1 = REGISTRATE.addLang("mode", ZYCraft.id("item_io"), "out1", "Output1")
            .withStyle(ChatFormatting.DARK_RED);
    public static final MutableComponent ITEM_IO_IN2 = REGISTRATE.addLang("mode", ZYCraft.id("item_io"), "in2", "Input2")
            .withStyle(ChatFormatting.GREEN);
    public static final MutableComponent ITEM_IO_OUT2 = REGISTRATE.addLang("mode", ZYCraft.id("item_io"), "out2", "Output2")
            .withStyle(ChatFormatting.YELLOW);

    public static final MutableComponent CURRENT_COLOR_LABEL = REGISTRATE.addLang("label", ZYCraft.id("current_color"), "Current color:")
            .withStyle(ChatFormatting.GRAY);
    public static final MutableComponent MODE_LABEL = REGISTRATE.addLang("label", ZYCraft.id("mode"), "Mode: ");
    public static final MutableComponent SOURCE_FLUID_LABEL = REGISTRATE.addLang("label", ZYCraft.id("source_fluid"), "Source fluid: ");
    public static final MutableComponent VOID_FLUID_LABEL = REGISTRATE.addLang("label", ZYCraft.id("void_fluid"), "Void fluid: ");
    public static final MutableComponent STORED_FLUID_LABEL = REGISTRATE.addLang("label", ZYCraft.id("stored_fluid"), "Stored fluid: ");

    public static final MutableComponent RED_INFO = REGISTRATE.addLang("info", ZYCraft.id("red"), "Red: %s")
            .withStyle(ChatFormatting.RED);
    public static final MutableComponent GREEN_INFO = REGISTRATE.addLang("info", ZYCraft.id("green"), "Green: %s")
            .withStyle(ChatFormatting.GREEN);
    public static final MutableComponent BLUE_INFO = REGISTRATE.addLang("info", ZYCraft.id("blue"), "Blue: %s")
            .withStyle(ChatFormatting.BLUE);
    public static final MutableComponent FLUID_INFO = REGISTRATE.addLang("info", ZYCraft.id("fluid"), "%s %s mB");

    public static final MutableComponent FABRICATOR_RECIPE_INCOMPATIBLE = REGISTRATE.addLang("jei", ZYCraft.id("fabricator"), "recipe_incompatible", "Recipe incompatible with Fabricator");
    ...
    public static MutableComponent addLangWithArgs(String type, ResourceLocation id, String localizedName, Object... args)
    {
        String key = Util.makeDescriptionId(type, id);
        REGISTRATE.addRawLang(key, localizedName);
        return Component.translatable(key, args);
    }

    public static MutableComponent addLangWithArgs(String type, ResourceLocation id, String suffix, String localizedName, Object... args)
    {
        String key = Util.makeDescriptionId(type, id) + "." + suffix;
        REGISTRATE.addRawLang(key, localizedName);
        return Component.translatable(key, args);
    }

    public static MutableComponent copy(MutableComponent component, Object... args)
    {
        return (component.getContents() instanceof TranslatableContents translatable ?
                Component.translatable(translatable.getKey(), args) :
                component)
