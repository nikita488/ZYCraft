...
{
    public static final PlacedFeature ZYCHORITE_VEIN = ZYConfiguredFeatures.ZYCHORITE_VEIN
            .placed(CountPlacement.of(ZYConfig.zychoriteAmount),
                    ...
                    BiomeFilter.biome());
    public static final PlacedFeature ORE_ALUMINIUM = ZYConfiguredFeatures.ORE_ALUMINIUM
            .placed(CountPlacement.of(ZYConfig.aluminiumAmount),
                    InSquarePlacement.spread(),
                    ...
                    BiomeFilter.biome());
    public static final PlacedFeature QUARTZ_CRYSTAL = ZYConfiguredFeatures.QUARTZ_CRYSTAL
            .placed(CountPlacement.of(UniformInt.of(104, 157)),
