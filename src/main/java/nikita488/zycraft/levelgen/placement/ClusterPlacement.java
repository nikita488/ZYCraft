...
public class ClusterPlacement extends FeatureDecorator<ClusterPlacementConfig>
{
    ...
    @Override
    public Stream<BlockPos> getPositions(DecorationContext context, Random random, ClusterPlacementConfig config, BlockPos pos)
    {
        ...
        for (int i = 0; i < config.generationAttempts; i++)
        {
            ...
            int surfaceHeight = Math.min(context.getHeight(Heightmap.Types.OCEAN_FLOOR_WG, x, z), context.getHeight(Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, x, z));
