...
public class ZychoriteVeinFeature extends Feature<ZychoriteVeinConfig>
{
    ...
    protected boolean doPlace(LevelAccessor accessor, Random random, ZychoriteVeinConfig config, double p_207803_4_, double p_207803_6_, double p_207803_8_, double p_207803_10_, double p_207803_12_, double p_207803_14_, int p_207803_16_, int p_207803_17_, int p_207803_18_, int p_207803_19_, int p_207803_20_)
    {
        int i = 0;
